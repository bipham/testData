...
class ReadingTypeQuestionService {
    ...
    public function getTypeQuestionName($type_question_id) {
        $type_question_name = $this->_readingTypeQuestionModel->getTypeQuestionName($type_question_id);
        return $type_question_name->name;
    }

    public function getLevelLessonIdByTypeQuestion($type_question_id) {
        $level_lesson = $this->_readingTypeQuestionModel->getLevelLessonIdByTypeQuestion($type_question_id);
        return $level_lesson->level_lesson_id;
    }
}
?>