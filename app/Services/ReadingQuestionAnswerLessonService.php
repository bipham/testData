...
class ReadingQuestionAnswerLessonService {
    ...
    public function getAllCommentsOfQuestion($type_lesson_id, $question_custom_id) {
        $list_comments = $this->_readingQuestionAndAnswerLessonModel->getAllCommentsOfQuestion($type_lesson_id, $question_custom_id);
    ...
    public function createNewCommentLesson($type_lesson_id, $question_custom_id, $user_id, $reply_comment_id, $content_cmt) {
        if ($user_id == $this->_userId) {
            ...
            $new_comment = $this->_readingQuestionAndAnswerLessonModel->createNewCommentLesson($type_lesson_id, $question_custom_id, $user_id, $reply_comment_id, $content_cmt, $private);
            return $new_comment;
        }
    }
