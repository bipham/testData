...
class ReadingQuestionAndAnswerLesson extends Model
{
    ...
    protected $fillable = ['type_lesson_id', 'question_custom_id', 'user_id', 'reply_comment_id', 'content_cmt', 'status', 'private'];
    ...
    public function getAllCommentsOfQuestion($type_lesson_id, $question_custom_id) {
        return DB::table('reading_question_and_answer_lessons')
                    ...
                    ->where('reading_question_and_answer_lessons.type_lesson_id', $type_lesson_id)
    ...
    public function createNewCommentLesson($type_lesson_id, $question_custom_id, $user_id, $reply_comment_id, $content_cmt, $private) {
        $new_comment_lesson = new ReadingQuestionAndAnswerLesson();
        $new_comment_lesson->type_lesson_id = $type_lesson_id;
