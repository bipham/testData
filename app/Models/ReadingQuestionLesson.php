...
class ReadingQuestionLesson extends Model
{
    ...
    public function updateQuestionType($type_lesson_id, $lesson_id, $type_question_id) {
        $this->where('type_lesson_id', $type_lesson_id)->where('lesson_id', $lesson_id)->update(['type_question_id' => $type_question_id, 'updated_at' => Carbon::now()]);
        return 'update-success';
    }
    ...
    public function getListTypeQuestionDetail($type_lesson_id, $lesson_id) {
        return $this->where('type_lesson_id', $type_lesson_id)->where('lesson_id', $lesson_id)->select('question_custom_id', 'type_question_id')->get()->all();
    }
}
