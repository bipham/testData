...
class ReadingPracticeLesson extends Model
{
    ...
    public function getPracticeLesson($start, $length) {
        return  DB::table('reading_practice_lessons')->offset($start)->limit($length)->select('id', 'title', 'level_user_id', 'image_feature', 'order_lesson')->get();
    }
    ...
    public function getTotalPracticesByTypeQuestionId($type_question_id) {
    ...
    public function getTypeQuestionOfPractice($lesson_id) {
    ...
    public function getDetailPracticeLessonForClientTest($lesson_id) {
        return $this->where('status', 1)->where('id', $lesson_id)->select('id', 'title', 'content_lesson', 'content_quiz', 'order_lesson', 'total_questions', 'type_question_id')->get()->first();
    }

    public function getDetailPracticeLessonForClientSolution($lesson_id) {
        return $this->where('status', 1)->where('id', $lesson_id)->select('id', 'title', 'content_highlight', 'content_answer_quiz', 'order_lesson', 'total_questions', 'type_question_id')->get()->first();
    }

    public function getDetailPracticeLessonForClientMiddleware($lesson_id) {
    ...
    public function getMinStepPracticeLesson($type_question_id){
    ...
    public function getMaxStepPracticeLesson($type_question_id){
    ...
    public function getPrePracticeLessonId($type_question_id, $current_order_lesson) {
    ...
    public function getNextPracticeLessonId($type_question_id, $current_order_lesson) {
        return $this->where('status', 1)->where('type_question_id', $type_question_id)->where('order_lesson', '>',$current_order_lesson)->select('id', 'order_lesson')->orderBy('order_lesson', 'asc')->get()->first();
    }
