...
{
    public function createNewComment($domain, $type_lesson_id){
        //Get variables:
        ...
        $new_comment = $readingQuestionAnswerLessonService->createNewCommentLesson($type_lesson_id, $question_custom_id, $user_id, $reply_comment_id, $content_cmt);
