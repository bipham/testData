...
@section('css')
    ...
    <link rel="stylesheet" href="{{asset('css/admin/readingEditLesson.css')}}">
    {{--    <meta name="csrf-token" content="{{ csrf_token() }}" />--}}
    <script src="{{asset('libs/ckeditor/ckeditor.js')}}"></script>
@endsection
@section('content')
    <div class="container upload-page-custom container-page-custom" data-level-lesson-id="{!! $level_lesson_id !!}" data-idquestion="{!! $last_question_custom_id !!}" data-lesson-id="{!! $lesson->id !!}" data-quiz-id="{!! $lesson->id !!}" @if($type_lesson_id < 3) data-type-question-id="{!! $lesson->type_question_id !!}" @else data-type-question-id="0" @endif data-type-lesson-id="{!! $type_lesson_id !!}">
...
@section('scripts')
    ...
    <script src="{{asset('js/admin/readingEditLessonFunctions.js')}}"></script>
    <script src="{{asset('js/admin/readingHighlight.js')}}"></script>
