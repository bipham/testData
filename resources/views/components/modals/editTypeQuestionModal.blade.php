            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="list_level{!! $lesson->id !!}" name="list_level{!! $lesson->id !!}" onchange="onChangeLevelLessonIdAdmin({!! $type_lesson_id !!}, {!! $lesson->id !!}, {!! $lesson->typeQuestion->id !!}, {!! $lesson->order_lesson !!})">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="list_type_questions{!! $lesson->id !!}" name="list_type_questions{!! $lesson->id !!}" onchange="changeTypeQuestionLessonAdmin({!! $type_lesson_id !!}, {!! $lesson->id !!}, {!! $lesson->typeQuestion->id !!}, {!! $lesson->order_lesson !!})">
