...
@section('content')
    <div class="container lesson-detail-page page-custom" data-level-lesson-id="{!! $level_lesson_id !!}" data-type-lesson-id="{!! $type_lesson_id !!}" data-type-question-id="{!! $type_question_id_current !!}">
        ...
        @foreach($paragraphs as $key_paragraph => $paragraph)
            <div class="lesson-detail panel-container paragraph-detail hidden paragraph-detail-{!! $paragraph->order_paragraph !!}" data-order-paragraph="{!! $paragraph->order_paragraph !!}" data-paragraph-id="{!! $paragraph->id !!}">
                <div class="left-panel-custom panel-left-{!! $paragraph->order_paragraph !!} panel-top-{!! $paragraph->order_paragraph !!}" id="lesson-content-area" data-lesson-id="{!! $lesson_detail->id !!}">
                ...
                <div class="right-panel-custom panel-right-{!! $paragraph->order_paragraph !!} panel-bottom-{!! $paragraph->order_paragraph !!}" id="quiz-test-area" data-quizId="{!! $lesson_detail->id !!}" data-limit-time="{!! $lesson_detail->limit_time !!}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        var limit_time = {!! $lesson_detail->limit_time !!};
        $('.btn-reading-start-test').click(function () {
            ...
            $('.lesson-detail.paragraph-detail-1').removeClass('hidden');
