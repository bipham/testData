/**
 * Created by BiPham on 27/11/2017.
 */
/**
...
var hltr = new TextHighlighter(sandbox, {
    ...
    onAfterHighlight: function (range, hlts) {
        ...
        if ($('.answer-area-2 .remove-ans-' + i).length == 0) {
          $('.answer-area-2 .remove-highlight-area-' + i).append('<div class="remove-ans-' + i + '">Remove highlight for anwser ' + i + ': <button class="btn btn-info remove" data-removeid="' + i + '">Remove</button></div>');
        }
    },
