...
for (var i = 1; i < 4; i++) {
    $(".panel-left-" + i).resizable({
        handleSelector: ".splitter-" + i,
        resizeHeight: true
    });
    $(".panel-top-" + i).resizable({
        handleSelector: ".splitter-horizontal-" + i,
        resizeWidth: false
    });
}
            ...
            if (list_notis.length != 0) {
                for (var i = 0; i < list_notis.length; i++) {
                    ...
                    noti_area.append(
                        ...
                        + '<img alt="' + data_noti.username + '" src="/storage/img/users/' + data_noti.avatar + '" class="img-user-noti-header img-auto-center-inner" />'
                        + '</span>'
                        ...
                        + '<img alt="time-noti" src="/imgs/original/time.png" class="img-time-noti" />'
                        + '</span>'
